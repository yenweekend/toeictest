...
const Register = () => {
    const [formData, setFormData] = useState({
        email: "", password: "", fullName: "", isTeacher: null
      });
        ...
        <div className="min-h-screen flex flex-col items-center justify-center">
            <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_0_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                ...
                <form>
                    ...
                    <p className="text-sm mt-4 text-gray-800">You have had an account <a href="/vi/auth/login" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Login here</a></p>
                    </div>
                    <div>
                        <label className="text-gray-800 text-xs block mb-2">FullName</label>
                        <div className="relative flex items-center">
                            <input name="fullName" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter userName" autoComplete='off' onChange={handleChange}/>
                        </div>
                    </div>
                    <div className="mt-8">
                    ...
                    <div className="mt-12">
                    <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" onClick={handleRegister}>
                        Đăng ký
                    </button>
                    </div>
                ...
                <h2 className="slogan text-[20px] text-center">Nền tảng kiểm tra, đánh giá được tin dùng <br></br> bởi hơn 300.000+ người dùng</h2>
                </div>
            </div>
        </div>
        {/* <Loading/> */}
   ...
   <RegisterStyled >
       <header className='px-[20px] py-2 flex items-center justify-between'>
           ...
           <div className="theme flex items-center cursor-pointer">
               <lucide-icon name="moon" size="20" className="mr-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-moon"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" key="a7tn18"></path></svg></lucide-icon>
       ...
       <div className="container  mx-auto w-[500px] border rounded-[4px] p-5 flex items-center justify-center flex-col mt-[100px] ">
           ...
           <div className="flex gap-3">
               <div className="role flex flex-col gap-3 items-center cursor-pointer p-5 border rounded-[4px] hover:scale-105 bg-white transition-all ease-linear duration-200" onClick={() => {
                   setFormData((state) => {
                       return {...state, isTeacher: false}
                   })
               }}>
               <lucide-icon name="graduation-cap"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-graduation-cap"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z" key="j76jl0"></path><path d="M22 10v6" key="1lu8f3"></path><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5" key="1r8lef"></path></svg></lucide-icon>
