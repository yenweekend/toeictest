...
const Loading = () => {
  return (
    <LoadingStyled>
                ...
                >
                    <path d="M90.8 52c3.5 6.2 7.1 11.7 9.8 17.7 4.4 9.7-2.9 20.7-13.8 20.9-11.8.2-23.7.2-35.5 0-11-.1-17.6-12.2-12-21.7.4-.8 1.8-1.4 2.7-1.4 9.9-.1 19.7-.1 29.6-.1 9.8 0 15.9-4.6 18.7-14 .1-.2.2-.5.5-1.4z" className="azt-svg-loading jobing-j"></path>
...
const LoadingStyled = styled.div`
    ...
    .azt-svg-loading {
        ...
        stroke-dashoffset: 0;
        animation: dash 1.5s linear .1s infinite alternate;
        --tw-text-opacity: 1;
